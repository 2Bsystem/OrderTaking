const KeyboardSaisieInt= {
    ...
    init() {
        ...
        // Setup main elements
        this.elements.main.classList.add("keyboard-saisie-int", "keyboard--hidden");
    ...
    open(initialValue, oninput, onclose) {
        ...
        document.getElementsByClassName("keyboard-saisie-decimal")[0].classList.add("keyboard--hidden");
