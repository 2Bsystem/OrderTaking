const KeyboardTriWithoutNumber = {
    elements: {
        main: null,
        keysContainer: null,
        keys: []
    ...
    init() {
        ...
        document.querySelectorAll(".use-keyboard-input-tri-without-number").forEach(element => {
            ...
            switch (key) {
                case "backspace":
                    ...
                    keyElement.addEventListener("click", () => {
                        ...
                        var input, filter, table, tr, td, i, j, txtValue,bodyTable,aucuneDonnee,aucuneDonneeTrouvee,type_recherche;
